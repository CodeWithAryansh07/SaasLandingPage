            ...
            <Element name="pricing">
                <div className='container'>
                    <div className="max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
                        ...
                        <div className='relative z-4 mx-auto flex w-[375px] rounded-3xl border-s4/25 bg-s1/50 p-2 backdrop-blur-[6px] max-md:w-[310px]'>
                                ...
                                <ul className='mx-auto space-y-4 xl:px-7 '>
                                    {plan.features.map((feature) => (
                                        <li key={feature} className='relative flex items-center gap-5'>
                                            <img src={'/images/check.png'} alt="check" className='size-10 object-fit' />
